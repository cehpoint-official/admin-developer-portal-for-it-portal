...
export const mockProjects: Project[] = [
  {
    ...
    description:
      "Complete redesign of an existing e-commerce platform with modern UI/UX improvements.",
  ...
  },
  {
    ...
    description:
      "Mobile application for tracking workouts, nutrition, and fitness goals with social sharing features.",
  ...
  },
  {
    ...
    description:
      "Online platform for real estate listings with virtual tours and property management features.",
  ...
  },
  {
    ...
    description:
      "Online learning platform with video courses, quizzes, and certification tracking.",
  ...
  },
  {
    ...
    description:
      "Digital ordering system for restaurants with kitchen management and delivery tracking.",
  ...
  },
  {
    ...
    description:
      "Comprehensive event management system for planning, ticketing, and attendee management.",
