...
// A function to generate static HTML for the quotation
export const generateQuotationHtml = (formData: QuotationData): string => {
  // Calculate costs
  const seniorDevRate = 75000;
  const juniorDevRate = 30000;
  const uiUxRate = 8000;
  const projectManagementCost = 50000;
...
//  const quotationNumber = generateQuotationNumber();
  ...
  // Create the HTML version of the quotation
  const quotationHtml = `
<!DOCTYPE html>
<html>
<head>
